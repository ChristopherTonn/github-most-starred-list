...
✔ Browser application bundle generation complete.
12 08 2025 11:59:57.132:INFO [karma-server]: Karma v6.4.4 server started at http://localhost:9876/
12 08 2025 11:59:57.132:INFO [launcher]: Launching browsers Chrome with concurrency unlimited
12 08 2025 11:59:57.135:INFO [launcher]: Starting browser Chrome
12 08 2025 11:59:58.503:INFO [Chrome 139.0.0.0 (Mac OS 10.15.7)]: Connected on socket hrvDxw-8sYOy1tzeAAAB with id 13591944
LOG: 'Date from now 30 days ago:', '2025-07-13'
Chrome 139.0.0.0 (Mac OS 10.15.7): Executed 0 of 14 SUCCESS (0 secs / 0 secs)
LOG: 'Date from now 30 days ago:', '2025-07-13'
Chrome 139.0.0.0 (Mac OS 10.15.7): Executed 1 of 14 SUCCESS (0 secs / 0.032 secs)
LOG: 'Date from now 30 days ago:', '2025-07-13'
Chrome 139.0.0.0 (Mac OS 10.15.7): Executed 2 of 14 SUCCESS (0 secs / 0.034 secs)
LOG: 'Repos loaded:', [Object{id: 1, name: 'test-repo', full_name: 'user/test-repo', html_url: 'https://github.com/user/test-repo', description: 'Just a test repo', stargazers_count: 42, open_issues_count: 3, created_at: '2025-08-01T00:00:00Z', owner: Object{login: ..., avatar_url: ...}}]
Chrome 139.0.0.0 (Mac OS 10.15.7): Executed 7 of 14 SUCCESS (0 secs / 0.04 secs)
LOG: 'Repos loaded:', [Object{id: 1, name: 'test-repo', full_name: 'user/test-repo', html_url: 'https://github.com/user/test-repo', description: 'Just a test repo', stargazers_count: 42, open_issues_count: 3, created_at: '2025-08-01T00:00:00Z', owner: Object{log
LOG: 'Repos loaded:', [Object{id: 1, name: 'test-repo', full_name: 'user/test-repo', html_url: 'https://github.com/user/test-repo', description: 'Just a test repo', stargazers_count: 42, open_issues_count: 3, created_at: '2025-08-01T00:00:00Z', owner: Object{login: ..., avatar_url: ...}}]
Chrome 139.0.0.0 (Mac OS 10.15.7): Executed 8 of 14 SUCCESS (0 secs / 0.043 secs)
LOG: 'Repos loaded:', [Object{id: 1, name: 'test-repo', full_name: 'user/test-repo', html_url: 'https://github.com/user/test-repo', description: 'Just a test repo', stargazers_count: 42, open_issues_count: 3, created_at: '2025-08-01T00:00:00Z', owner: Object{log
LOG: 'Repos loaded:', [Object{id: 1, name: 'test-repo', full_name: 'user/test-repo', html_url: 'https://github.com/user/test-repo', description: 'Just a test repo', stargazers_count: 42, open_issues_count: 3, created_at: '2025-08-01T00:00:00Z', owner: Object{login: ..., avatar_url: ...}}]
Chrome 139.0.0.0 (Mac OS 10.15.7): Executed 9 of 14 SUCCESS (0 secs / 0.044 secs)
LOG: 'Repos loaded:', [Object{id: 1, name: 'test-repo', full_name: 'user/test-repo', html_url: 'https://github.com/user/test-repo', description: 'Just a test repo', stargazers_count: 42, open_issues_count: 3, created_at: '2025-08-01T00:00:00Z', owner: Object{log
Chrome 139.0.0.0 (Mac OS 10.15.7): Executed 14 of 14 SUCCESS (0.057 secs / 0.048 secs)
TOTAL: 14 SUCCESS

DevTools listening on ws://127.0.0.1:60425/devtools/browser/3c869da7-0025-4a16-82f3-7ca8fa4954ee
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  Repo List Item
    ✓ should display repo list items (1327ms)
    ✓ should show profile picture (156ms)
    ✓ should display title (142ms)
    ✓ should display description (171ms)
    ✓ should show stars count (129ms)
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  Repo List
    ✓ should display the repo list page (158ms)
    ✓ should show at least one list item (70ms)
...
====================================================================================================
  ...
  ├────────────────────────────────────────────────────────────────────────────────────────────────┤
  │ ✔  repo-list.cy.ts                          248ms        2        2        -        -        - │
  └────────────────────────────────────────────────────────────────────────────────────────────────┘
    ✔  All specs passed!                        00:02        7        7        -        -        -

christophertonn@MacBook-Pro-von-Christopher github-most-starred-list %
christophertonn@MacBook-Pro-von-Christopher github-most-starred-list % npm test
